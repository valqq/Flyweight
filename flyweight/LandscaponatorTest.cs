...
namespace flyweight
{
    class LandscaponatorTest
    {
        static void Main(string[] args)
        {
            TreeManager trees = new TreeManager();
            trees.AddTree(new Point(5, 10), 5); trees.AddTree(new Point(10, 2), 50);
            ...
            trees.AddTree(new Point(17, 9), 25); trees.AddTree(new Point(24, 10), 52);
            trees.DisplayTrees();
        }
    }
}